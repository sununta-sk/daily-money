 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var w_;function zS(){return w_||(w_=1,function(r){function t(j,tt){var lt=j.length;j.push(tt);t:for(;0<lt;){var qt=lt-1>>>1,D=j[qt];if(0<o(D,tt))j[qt]=tt,j[lt]=D,lt=qt;else break t}}function n(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var tt=j[0],lt=j.pop();if(lt!==tt){j[0]=lt;t:for(var qt=0,D=j.length,X=D>>>1;qt<X;){var nt=2*(qt+1)-1,W=j[nt],ft=nt+1,Ct=j[ft];if(0>o(W,lt))ft<D&&0>o(Ct,W)?(j[qt]=Ct,j[ft]=lt,qt=ft):(j[qt]=W,j[nt]=lt,qt=nt);else if(ft<D&&0>o(Ct,lt))j[qt]=Ct,j[ft]=lt,qt=ft;else break t}}return tt}function o(j,tt){var lt=j.sortIndex-tt.sortIndex;return lt!==0?lt:j.id-tt.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,g=f.now();r.unstable_now=function(){return f.now()-g}}var p=[],y=[],T=1,I=null,C=3,H=!1,$=!1,et=!1,Z=!1,St=typeof setTimeout=="function"?setTimeout:null,dt=typeof clearTimeout=="function"?clearTimeout:null,ct=typeof setImmediate<"u"?setImmediate:null;function Ot(j){for(var tt=n(y);tt!==null;){if(tt.callback===null)s(y);else if(tt.startTime<=j)s(y),tt.sortIndex=tt.expirationTime,t(p,tt);else break;tt=n(y)}}function _t(j){if(et=!1,Ot(j),!$)if(n(p)!==null)$=!0,It||(It=!0,k());else{var tt=n(y);tt!==null&&Bt(_t,tt.startTime-j)}}var It=!1,M=-1,b=5,R=-1;function N(){return Z?!0:!(r.unstable_now()-R<b)}function V(){if(Z=!1,It){var j=r.unstable_now();R=j;var tt=!0;try{t:{$=!1,et&&(et=!1,dt(M),M=-1),H=!0;var lt=C;try{e:{for(Ot(j),I=n(p);I!==null&&!(I.expirationTime>j&&N());){var qt=I.callback;if(typeof qt=="function"){I.callback=null,C=I.priorityLevel;var D=qt(I.expirationTime<=j);if(j=r.unstable_now(),typeof D=="function"){I.callback=D,Ot(j),tt=!0;break e}I===n(p)&&s(p),Ot(j)}else s(p);I=n(p)}if(I!==null)tt=!0;else{var X=n(y);X!==null&&Bt(_t,X.startTime-j),tt=!1}}break t}finally{I=null,C=lt,H=!1}tt=void 0}}finally{tt?k():It=!1}}}var k;if(typeof ct=="function")k=function(){ct(V)};else if(typeof MessageChannel<"u"){var S=new MessageChannel,st=S.port2;S.port1.onmessage=V,k=function(){st.postMessage(null)}}else k=function(){St(V,0)};function Bt(j,tt){M=St(function(){j(r.unstable_now())},tt)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(j){j.callback=null},r.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<j?Math.floor(1e3/j):5},r.unstable_getCurrentPriorityLevel=function(){return C},r.unstable_next=function(j){switch(C){case 1:case 2:case 3:var tt=3;break;default:tt=C}var lt=C;C=tt;try{return j()}finally{C=lt}},r.unstable_requestPaint=function(){Z=!0},r.unstable_runWithPriority=function(j,tt){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var lt=C;C=j;try{return tt()}finally{C=lt}},r.unstable_scheduleCallback=function(j,tt,lt){var qt=r.unstable_now();switch(typeof lt=="object"&&lt!==null?(lt=lt.delay,lt=typeof lt=="number"&&0<lt?qt+lt:qt):lt=qt,j){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=lt+D,j={id:T++,callback:tt,priorityLevel:j,startTime:lt,expirationTime:D,sortIndex:-1},lt>qt?(j.sortIndex=lt,t(y,j),n(p)===null&&j===n(y)&&(et?(dt(M),M=-1):et=!0,Bt(_t,lt-qt))):(j.sortIndex=D,t(p,j),$||H||($=!0,It||(It=!0,k()))),j},r.unstable_shouldYield=N,r.unstable_wrapCallback=function(j){var tt=C;return function(){var lt=C;C=tt;try{return j.apply(this,arguments)}finally{C=lt}}}}(Ad)),Ad}var R_;function BS(){return R_||(R_=1,Td.exports=zS()),Td.exports}var Sd={exports:{}},je={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lO(r){r=$i(r,sn);const t=$i(r.firestore,io);return HD(eg(t),r._key).then(n=>dO(t,r,n))}class fA extends sO{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ya(t)}convertReference(t){const n=this.convertDocumentKey(t,this.firestore._databaseId);return new sn(this.firestore,null,n)}}function uO(r){r=$i(r,no);const t=$i(r.firestore,io),n=eg(t),s=new fA(t);return nO(r._query),jD(n,r._query).then(o=>new aO(t,s,r,o))}function cO(r,t,n){r=$i(r,sn);const s=$i(r.firestore,io),o=cA(r.converter,t);return hg(s,[nA(ag(s),"setDoc",r._key,o,r.converter!==null,n).toMutation(r._key,Hn.none())])}function hO(r){return hg($i(r.firestore,io),[new Lm(r._key,Hn.none())])}function fO(r,t){const n=$i(r.firestore,io),s=Cc(r),o=cA(r.converter,t);return hg(n,[nA(ag(r.firestore),"addDoc",s._key,o,r.converter!==null,{}).toMutation(s._key,Hn.exists(!1))]).then(()=>s)}function hg(r,t){return function(s,o){const c=new Gi;return s.asyncQueue.enqueueAndForget(async()=>OD(await qD(s),o,c)),c.promise}(eg(r),t)}function dO(r,t,n){const s=n.docs.get(t._key),o=new fA(r);return new hA(r,o,t._key,s,new _l(n.hasPendingWrites,n.fromCache),t.converter)}(function(t,n=!0){(function(o){Wa=o})($a),di(new jn("firestore",(s,{instanceIdentifier:o,options:c})=>{const f=s.getProvider("app").getImmediate(),g=new io(new tC(s.getProvider("auth-internal")),new iC(f,s.getProvider("app-check-internal")),function(y,T){if(!Object.prototype.hasOwnProperty.apply(y.options,["projectId"]))throw new rt(Y.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ol(y.options.projectId,T)}(f,o),f);return c=Object.assign({useFetchStreams:n},c),g._setSettings(c),g},"PUBLIC").setMultipleInstances(!0)),On(gv,pv,t),On(gv,pv,"esm2017")})();const mO={apiKey:"AIzaSyDxYyDUPCRPb5O6-GucCcmO4jcdf9rBEho",authDomain:"daily-money-94f02.firebaseapp.com",projectId:"daily-money-94f02",storageBucket:"daily-money-94f02.firebasestorage.app",messagingSenderId:"31843473349",appId:"1:31843473349:web:249d43c7856d1b60b39dac",measurementId:"G-6WZTW0WFRC"},fg=DE(mO);Kw(fg);const Ld=$I(fg),gO=new Hi,ml=QD(fg);function pO(){const[r,t]=Un.useState(""),[n,s]=Un.useState(""),[o,c]=Un.useState(""),[f,g]=Un.useState("daily"),[p,y]=Un.useState([]),[T,I]=Un.useState(null),[C,H]=Un.useState(!1),[$,et]=Un.useState(!1);Un.useEffect(()=>{const S=LR(Ld,st=>{I(st),st?Z(st.uid):(y([]),t(""))});return()=>S()},[]);const Z=async S=>{H(!0);try{const st=await lO(Cc(ml,"users",S,"data","salary"));st.exists()&&t(st.data().amount.toString());const Bt=rO(uE(ml,"users",S,"costs")),tt=(await uO(Bt)).docs.map(lt=>({id:lt.id,...lt.data()}));y(tt)}catch(st){console.error("Error loading user data:",st)}H(!1)},St=async S=>{if(T)try{await cO(Cc(ml,"users",T.uid,"data","salary"),{amount:parseFloat(S)||0,updatedAt:new Date})}catch(st){console.error("Error saving salary:",st)}},dt=async S=>{if(!T)return console.error("No user logged in"),null;try{console.log("Saving cost for user:",T.uid),console.log("Cost data:",S);const st=await fO(uE(ml,"users",T.uid,"costs"),{name:S.name,amount:S.amount,period:S.period,createdAt:new Date});return console.log("Cost saved successfully with ID:",st.id),st.id}catch(st){throw console.error("Detailed Firestore error:",{code:st.code,message:st.message,stack:st.stack}),st.code==="permission-denied"?console.error("Firestore permission denied. Check security rules."):st.code==="unavailable"&&console.error("Firestore service unavailable."),st}},ct=async S=>{if(T)try{await hO(Cc(ml,"users",T.uid,"costs",S))}catch(st){console.error("Error deleting cost:",st)}},Ot=async()=>{try{console.log("Attempting Google sign-in...");const S=await sI(Ld,gO);console.log("Sign-in successful:",S.user)}catch(S){console.error("Sign-in error details:",{code:S.code,message:S.message,email:S.email,credential:S.credential}),S.code==="auth/popup-closed-by-user"?alert("Sign-in was cancelled. Please try again."):S.code==="auth/popup-blocked"?alert("Pop-up was blocked. Please allow pop-ups for this site and try again."):alert(`Sign-in failed: ${S.message}`)}},_t=async()=>{try{await zR(Ld)}catch(S){console.error("Error signing out:",S)}},It=async()=>{if(!n.trim()||!o.trim()){alert("Please fill in both cost name and amount");return}const S=parseFloat(o);if(isNaN(S)||S<=0){alert("Please enter a valid amount");return}et(!0);try{const st={name:n.trim(),amount:S,period:f},Bt=await dt(st);Bt?(y([...p,{...st,id:Bt}]),s(""),c(""),console.log("Cost added successfully:",st)):alert("Failed to save cost. Please try again.")}catch(st){console.error("Error adding cost:",st),alert(`Error adding cost: ${st.message}

Error code: ${st.code}`)}finally{et(!1)}},M=S=>{S.key==="Enter"&&It()},b=async S=>{const st=S.target.value;if(t(st),st&&!isNaN(parseFloat(st)))try{await St(st),console.log("Salary saved successfully:",st)}catch(Bt){console.error("Error saving salary:",Bt),alert("Error saving salary. Please try again.")}},R=()=>p.reduce((S,st)=>{switch(st.period){case"daily":return S+st.amount*30;case"weekly":return S+st.amount*4.33;case"monthly":return S+st.amount;case"yearly":return S+st.amount/12;default:return S}},0),N=()=>{const S=new Date;return new Date(S.getFullYear(),S.getMonth()+1,0).getDate()},V=()=>{const S=parseFloat(r)||0,st=R(),Bt=S-st,j=N();return Bt/j},k=async S=>{await ct(S),y(p.filter(st=>st.id!==S))};return ot.createElement("div",{className:"p-6 max-w-4xl mx-auto"},ot.createElement("h1",{className:"text-3xl font-bold mb-6 bg-purple-400 p-4 rounded"},"Budget Dashboard"),ot.createElement("div",{className:"mb-6 p-4 border rounded bg-gray-50"},T?ot.createElement("div",{className:"flex items-center justify-between"},ot.createElement("div",{className:"flex items-center gap-3"},ot.createElement("img",{src:T.photoURL,alt:"Profile",className:"w-8 h-8 rounded-full"}),ot.createElement("span",null,"Welcome, ",T.displayName,"!")),ot.createElement("button",{onClick:_t,className:"px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600"},"Sign Out")):ot.createElement("div",{className:"text-center"},ot.createElement("p",{className:"mb-4"},"Please sign in to use the budget dashboard"),ot.createElement("button",{onClick:Ot,className:"px-6 py-3 bg-blue-500 text-white rounded hover:bg-blue-600 flex items-center gap-2 mx-auto"},ot.createElement("svg",{className:"w-5 h-5",viewBox:"0 0 24 24"},ot.createElement("path",{fill:"currentColor",d:"M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"}),ot.createElement("path",{fill:"currentColor",d:"M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"}),ot.createElement("path",{fill:"currentColor",d:"M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"}),ot.createElement("path",{fill:"currentColor",d:"M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"})),"Sign in with Google"))),T&&ot.createElement(ot.Fragment,null,C?ot.createElement("div",{className:"text-center py-8"},ot.createElement("div",{className:"inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500"}),ot.createElement("p",{className:"mt-2 text-gray-600"},"Loading your budget data...")):ot.createElement(ot.Fragment,null,ot.createElement("div",{className:"mb-6"},ot.createElement("label",{className:"block text-sm font-medium mb-2"},"Monthly Salary"),ot.createElement("input",{type:"number",placeholder:"Enter monthly salary",value:r,onChange:b,className:"border border-gray-300 rounded px-3 py-2 w-full"})),ot.createElement("div",{className:"mb-6 p-4 border rounded"},ot.createElement("h2",{className:"text-xl font-semibold mb-4"},"Add Cost"),ot.createElement("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-2 mb-2"},ot.createElement("input",{placeholder:"Cost name",value:n,onChange:S=>s(S.target.value),onKeyPress:M,className:"border border-gray-300 rounded px-3 py-2"}),ot.createElement("input",{type:"number",placeholder:"Amount",value:o,onChange:S=>c(S.target.value),onKeyPress:M,className:"border border-gray-300 rounded px-3 py-2"}),ot.createElement("select",{value:f,onChange:S=>g(S.target.value),className:"border border-gray-300 rounded px-3 py-2"},ot.createElement("option",{value:"daily"},"Daily"),ot.createElement("option",{value:"weekly"},"Weekly"),ot.createElement("option",{value:"monthly"},"Monthly"),ot.createElement("option",{value:"yearly"},"Yearly")),ot.createElement("button",{onClick:It,disabled:$,className:`px-4 py-2 text-white rounded ${$?"bg-gray-400 cursor-not-allowed":"bg-blue-500 hover:bg-blue-600"}`},$?"Adding...":"Add"))),ot.createElement("div",{className:"p-4 bg-blue-50 border rounded mb-6"},ot.createElement("h2",{className:"text-xl font-semibold mb-4"},"Budget Report"),ot.createElement("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4"},ot.createElement("div",{className:"p-3 bg-white rounded border"},ot.createElement("div",{className:"text-sm text-gray-600"},"Monthly Salary"),ot.createElement("div",{className:"text-2xl font-bold"},"฿",parseFloat(r)||0)),ot.createElement("div",{className:"p-3 bg-white rounded border"},ot.createElement("div",{className:"text-sm text-gray-600"},"Monthly Costs"),ot.createElement("div",{className:"text-2xl font-bold text-red-600"},"฿",R().toFixed(2))),ot.createElement("div",{className:"p-3 bg-white rounded border"},ot.createElement("div",{className:"text-sm text-gray-600"},"Daily Free Money"),ot.createElement("div",{className:"text-2xl font-bold text-green-600"},"฿",V().toFixed(2))))),ot.createElement("div",{className:"mb-6"},ot.createElement("h2",{className:"text-xl font-semibold mb-4"},"Your Costs"),ot.createElement("div",{className:"grid gap-2"},p.map(S=>ot.createElement("div",{key:S.id,className:"flex justify-between items-center p-3 border rounded bg-gray-50"},ot.createElement("span",{className:"font-medium"},S.name),ot.createElement("div",{className:"flex items-center gap-4"},ot.createElement("span",{className:"font-medium"},"฿",S.amount," (",S.period,")"),ot.createElement("button",{onClick:()=>k(S.id),className:"text-red-500 hover:text-red-700"},"×")))))))))}GS.createRoot(document.getElementById("root")).render(ot.createElement(Un.StrictMode,null,ot.createElement(pO,null)));
