...
import { expensesPrompt } from "./prompts";

const ExpensesVoiceInput = ({ onVoiceResult }) => {
  ...
  const processAudio = async (audioBlob) => {
    ...
    try {
      ...
      console.log("[EXPENSES VOICE EXTRACTED]", extractedData);
...
export default ExpensesVoiceInput;
